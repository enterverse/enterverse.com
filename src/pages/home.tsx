...
// 				<header
// 					className={`fixed top-0 z-50 flex h-32 w-full items-center justify-between bg-black/0 p-6 transition-all duration-500 xl:justify-center xl:px-32 ${
...
// 							</p>
// 						</div>
// 						<div className="mb-16 flex w-full flex-col gap-6 text-lg xl:mb-0 xl:w-2/3">
...
// 				<section
// 					className="bg-enterlink-mobile-gradient flex w-full flex-col items-start justify-center bg-cover p-6 py-16 xl:bg-section2-gradient xl:p-32"
// 					id="Enterlink"
// 				>
// 					<div className="flex w-full flex-col items-center justify-center xl:flex-row">
// 						<div className="flex w-full flex-col items-start justify-center">
// 							<div className="mb-14 flex h-24 flex-row items-center gap-6">
...
// 						</div>
// 					</div>
// 					<div className="flex h-auto w-full flex-col items-start justify-center gap-16 xl:flex-row">
// 						<div className="mb-24 flex flex-col gap-6 xl:mb-0">
...
// 				<section
// 					className="flex w-full flex-col items-start justify-center gap-16 bg-section3-gradient xl:gap-32"
// 					id="about"
// 				>
// 					{/* <div className="flex w-full flex-col items-start justify-center gap-16 xl:gap-32"> */}
// 					{/* <div className="flex flex-col gap-6 p-6  xl:w-1/2 xl:p-32">
...
// 							</p>
// 						</div> */}
// 					{/* <div className="flex flex-col justify-center gap-6 pb-16 xl:pb-32"> */}
...
// 					{/* <div className="flex size-full flex-col gap-6 px-6 xl:w-2/3  xl:px-32">
...
// 									<ChevronLeft className="size-8" />
// 								</CarouselBackButton>
// 								<CarouselItems className="relative z-10 gap-6 px-6 duration-500 xl:gap-16 xl:px-32">
// 									{ExecutiveImages.map((member, index) => (
// 										<CarouselItem
// 											className="flex h-fit w-60 flex-col items-start justify-start gap-6 rounded-lg xl:w-96"
// 											key={index}
// 										>
// 											<img
// 												alt={member.name}
// 												className="size-60 rounded-lg xl:size-96"
// 												src={member.img}
// 											/>
...
// 									<ChevronLeft className="size-8" />
// 								</CarouselBackButton>
// 								<CarouselItems className="relative z-10 gap-6 px-6 duration-500 xl:gap-12 xl:px-32">
// 									{TeamImages.map((member, index) => (
// 										<CarouselItem
// 											className="flex h-fit flex-col items-start justify-start gap-6 rounded-lg"
// 											key={index}
// 										>
// 											<img
// 												alt={member.name}
// 												className="size-60 rounded-lg object-cover xl:size-72"
// 												src={member.img}
// 											/>
// 											<p className="font-dm-sans text-2xl font-bold leading-9 text-white">
// 												{member.name}
// 											</p>
// 											<p className="max-w-60 font-dm-sans text-xl text-white xl:max-w-72">
// 												{member.position}
// 											</p>
// 										</CarouselItem>
// 									))}
...
// 				<section
// 					className="bg-interested-mobile-gradient flex w-full flex-col items-start justify-center p-6 xl:bg-footer-gradient xl:px-32 xl:pt-32"
// 					id="contact"
// 				>
...
// 							</div>
// 						</div>
// 						<div className="my-16 flex size-full flex-col gap-6">
...
// <footer className="flex h-96 w-full flex-col-reverse items-center justify-evenly gap-6 xl:h-48 xl:flex-row xl:justify-between xl:gap-2 xl:pb-24 xl:pt-36">
